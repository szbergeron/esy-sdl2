            ...
            for (i = 0; i < len; ++i) {
                ...
                case EV_REL:
                    ...
                    case REL_Y:
                        ...
                        break;
                    case REL_WHEEL:
                        SDL_SendMouseWheel(mouse->focus, mouse->mouseID, 0, events[i].value, SDL_MOUSEWHEEL_NORMAL, 0);
                        break;
                    case REL_HWHEEL:
                        SDL_SendMouseWheel(mouse->focus, mouse->mouseID, events[i].value, 0, SDL_MOUSEWHEEL_NORMAL, 0);
                        break;
                    default:
                        break;
                    }
